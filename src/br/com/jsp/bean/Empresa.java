...
public class Empresa{
	...
	public Empresa(String login, String senha, String nome, String cnpj, String email, String telefone) {
	...
	public static void main(String[] args) {
		...
		e.setConta(new Conta());
		e.getConta().setSenha("Turismo");
		
		System.out.println(e.getConta().getSenha());
		System.out.println(e.getConta().getSalt());
		
	}
	
	public Empresa(Conta conta, String nome, String cnpj, String email, String telefone) {
		this.conta = conta;
		this.nome = nome;
		this.cnpj = cnpj;
		this.email = email;
