...
<%
	...
	Resposta<ArrayList<Empresa>> respEmpresa = EmpresaDao.selectWhere("nome", Where.LIKE,
			"%" + nomeEmpresa + "%");
	...
	if (!respostaNome.getFuncionou()) {
		...
		if (respostaNome.getObjeto().isEmpty() || respostaData.getObjeto().isEmpty()
				|| respEmpresa.getObjeto().isEmpty()) {
