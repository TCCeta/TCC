...
<%
	...
	if (request.getParameter("msg") != null) {
		...
		case "saidaInvalida":
			out.print(
					"<div class='alert alert-success msg'>Você não está logado!   <button type='button' class='close' data-dismiss='alert' aria-label='Close'> <span aria-hidden='true'>&times;</span></button></div>");
			break;	
