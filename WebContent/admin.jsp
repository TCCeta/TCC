...
<div>
	...
	<div class="tab-content">
		<!--Aba dos itens-->
		<form role="tabpanel" class="jumbotron tab-pane active"
			id="cadastroDeItem" action="acoes/cadastrarItem.jsp">
			<h1 class="titulosTabs">
				<strong> Cadastro de Items </strong>
			</h1>
			<div class="formularioCadastro divLeft">
				<input type="text" placeholder="Nome" class="form-control"
					name="dad_nomeItem"> <br> <input type="date"
					class="data form-control" name="dat_perdidoItem"><br>
				...
				<img id="imagemItem" src="imagens/180.png" alt="your image"
					...
					<center>
						<input type="submit" class="btn btn-default" value="Cadastrar item">
