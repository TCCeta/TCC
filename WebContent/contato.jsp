...
<div class="jumbotron telaContato">
	<form>
		...
		<p><strong>Telefone:</strong>  (47) 3322-3344</p>
		<p><strong>Zack e Cody:</strong>  (47) 99876-5432</p>
		<p><strong>Endereço:</strong> Shopping Neumarkt (piso principal) Rua 7 de Setembro
			1213 Loja 129 - Centro 89.010-911 - Blumenau / SC
		<p>
	</form>
</div>
<div>
