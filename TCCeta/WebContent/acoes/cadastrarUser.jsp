...
<%
	...
	Usuario u = new Usuario(usuarioInformado, senhaInformado, nomeInformado, cpfInformado, emailInformado,
			telefoneInformado,
			new Local(ruaInformada, bairroInformado, cidadeInformada, estadoInformado, cepInformado));
